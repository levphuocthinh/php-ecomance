                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">Số Lượng Sản Phẩm</th>
                            ...
                            <tbody>
                                <tr v-for="(value, key) in list">
                                    ...
                                    <td class="text-center align-middle">@{{ value.ngay_hoa_don }}</td>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr v-for="(value, key) in detail">
                                                    ...
                                                    <td class="-middle">@{{ value.ten_san_pham }}</td>
                                                    <td class="align-middle">@{{ value.so_luong_mua }}</td>
                                                    <td class="text-center align-middle">@{{ numberFormat(value.thanh_tien_mua) }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
        ...
        new Vue({
            ...
            methods: {
                getData() {
                    ...
                    axios
                        .post('{{ Route('dataSanPhamMotNgay') }}', payload)
                        .then((res) => {
                ...
                xemChiTiet(payload) {
                    axios
                        .post('{{ Route('dataChiTietsanPhamMotNgay') }}', payload)
                        .then((res) => {
