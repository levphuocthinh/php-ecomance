                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(value, key) in list">
                                ...
                                <td class="text-center align-middle">@{{ value.so_don }}</td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="(value, key) in detail">
                                                ...
                                                <td class="-middle">@{{ value.ho }} @{{ value.dem }} @{{ value.ten }}</td>
        ...
        new Vue({
            ...
            methods: {
                getData() {
                    ...
                    axios
                        .post('{{ Route('dataSoDonMotNgay') }}', payload)
                        .then((res) => {
                ...
                xemChiTiet(payload) {
                    axios
                        .post('{{ Route('dataChiTietSoDonMotNgay') }}', payload)
                        .then((res) => {
