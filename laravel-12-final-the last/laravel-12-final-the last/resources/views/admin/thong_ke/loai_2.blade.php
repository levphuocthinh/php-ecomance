        ...
        new Vue({
            ...
            methods: {
                getData() {
                    ...
                    axios
                        .post('{{ Route('dataThongKe2') }}', payload)
                        .then((res) => {
                ...
                xemChiTiet(payload) {
                    ...
                    axios
                        .post('{{ Route('dataChiTietThongKe2') }}', payload)
                        .then((res) => {
        ...
        function getChart() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    char_14.data.labels = ten_du_lieu;
                    char_14.data.datasets[0].data = du_lieu;
                    char_14.update();
                })
                .catch((res) => {
                    $.each(res.response.data.errors, function(k, v) {
