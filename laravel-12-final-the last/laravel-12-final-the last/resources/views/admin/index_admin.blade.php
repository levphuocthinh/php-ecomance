                ...
                <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mb-1">
                                    ...
                                    <input v-model="add.id_rule" type="text" class="form-control" placeholder="Nhập tên">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mb-1">
                                    ...
                                    <select v-model="add.is_active" class="form-control">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="themMoi" v-on:click="themMoi()" class="btn btn-primary"
                            data-bs-dismiss="modal">Thêm Mới Admin</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-bordered" id="danh_sach">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-nowrap">Rule</th>
                                ...
                                <tbody>
                                    <template v-for="(value, key) in list">
                                        <tr>
                                            ...
                                            <td class="text-nowrap">@{{ value.id_rule }}</td>
                        ...
                        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Bạn có muốn xóa admin <b>@{{ del.ho_lot }} @{{ del.ten }}</b>
                                            này không?</p>
            ...
            new Vue({
                ...
                methods: {
                    ...
                    timKiem() {
                        ...
                        axios
                            .post('{{ Route('searchAdmin') }}', payload)
                            .then((res) => {
                                this.list = res.data.data;
                            });
                    },
                    doiTrangThai(payload) {
                        axios
                            .post('{{ Route('statusAdmin') }}', payload)
                            .then((res) => {
                                this.timKiem();
                    ...
                    themMoi() {
                        axios
                            .post('{{ Route('createAdmin') }}', this.add)
                            .then((res) => {
                                if (res.data.status) {
                    ...
                    update() {
                        axios
                            .post('{{ Route('updateAdmin') }}', this.edit)
                            .then((res) => {
                                if (res.data.status) {
                                    toastr.success("Đã cập nhật admin", "Thành công!");
                                    // this.list.push(this.add);
                                    this.timKiem();
                                }
                            })
                    ...
                    checkEmail() {
                        axios
                            .post('{{ Route('checkMailAdmin') }}', this.add)
                            .then((res) => {
                                if (res.data.status) {
                    ...
                    checkEmailUpdate() {
                        axios
                            .post('{{ Route('checkMailUpdateAdmin') }}', this.edit)
                            .then((res) => {
                                if (res.data.status) {
                                    toastr.success(res.data.message, "Thành công!");
